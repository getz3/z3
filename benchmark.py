...
def main():
    ...
    parser.add_argument("--access-key", default="z3admin", help="Default access key (zs3/rustfs)")
    parser.add_argument("--secret-key", default="z3admin", help="Default secret key (zs3/rustfs)")
